...
if(USAGE == 'registrementUser'){
    $mail->Subject = "Message de confirmation de compte";

                // Créer le lien complet
    $lien = 'http://localhost/pfa_projet/front/verificationEmailSuccess.php?id='.$idUser;
...
if(USAGE == 'findlogin'){
    $mail->Subject = "Message de confirmation de compte";
                ...
                // Créer le lien complet
    $lien = 'http://localhost/pfa_projet/front/changerPassword.php?id='.$idUser;
